...
If you want the configuration-oriented follow-up, [How I Build Shopify Swatches for Product and Collection Pages](https://the-lean-ecommerce.github.io/2026/06/23/how-i-choose-between-variant-swatches-and-linked-products-in-shopify/) covers the decision side, and [How to Roll Out Shopify Swatches Without Touching Theme Code](https://the-lean-ecommerce.github.io/2026/07/10/how-to-roll-out-shopify-swatches-without-touching-theme-code/) shows the no-code rollout pattern I would use on a live store.
